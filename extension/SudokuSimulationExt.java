 ...
 * 
 * Purpose of class: Simulate the Sudoku solver with different initial locked cell counts using MRV + Degree Heuristic
 */

 import java.util.concurrent.*;

 public class SudokuSimulationExt {
     ...
     public static void main(String[] args) {
         ...
         for (int numLocked = 0; numLocked <= 40; numLocked++) {
             ...
             for (int test = 0; test < NUM_TESTS; test++) {
                 ...
                 SudokuExt game = new SudokuExt(numLocked, 0);
